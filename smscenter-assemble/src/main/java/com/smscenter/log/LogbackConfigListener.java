 ...
 *
 *	<listener>
 *		<listener-class>com.yjf.common.com.smscenter.log.LogbackConfigListener</listener-class>
 *	</listener>
 *
 * }
...
//        ShutdownHooks.shutdownAll(); //TODO:应该是结束进程
        LoggerContext loggerContext = (LoggerContext) LoggerFactory.getILoggerFactory();
        loggerContext.stop();
    }
    ...
    private static String resolveClasspath(String resourceLocation) {
        ...
        if (url == null) {
//            throw new CommonException("没有找到logback配置文件:" + resourceLocation); //TODO: 异常处理
        }
        return url.getFile();
